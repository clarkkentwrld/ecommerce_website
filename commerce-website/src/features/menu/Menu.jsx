...
// --- IMPORT IMAGES ---
// Ensure these filenames match exactly what is in your assets folder
...
const Menu = () => {
  ...
  const menuData = {
    ...
    "Heart-Healthy": {
      subtitle: "The 'Puso' Line - Low sodium, high fiber.",
      color: "#e67e22", // Orange
      items: [
        { 
          title: "Fish Staples", 
          b: "Smoked Fish, Brown Rice", 
          l: "Paksiw na Bangus", 
          d: "Steamed Fish, Soy & Ginger",
          nutrition: { cal: "1100", protein: "85g", carbs: "140g", fat: "25g" }
        },
        { 
          title: "Chicken Breast", 
          b: "Oatmeal, Apple, Cinnamon", 
          l: "Chicken Salpicao (Olive Oil)", 
          d: "Lemon Herb Chicken, Corn",
          nutrition: { cal: "1120", protein: "88g", carbs: "135g", fat: "28g" }
        },
        { 
          title: "Vinegar Based", 
          b: "Baked Daing na Bangus", 
          l: "Chicken Adobo Puti", 
          d: "Fish Escabeche",
          nutrition: { cal: "1110", protein: "86g", carbs: "138g", fat: "26g" }
        },
        { 
          title: "Veggie Heavy", 
          b: "Egg White Omelet", 
          l: "Ginisang Munggo (Tinapa)", 
          d: "Vegetable Curry (Chicken)",
          nutrition: { cal: "1090", protein: "84g", carbs: "142g", fat: "24g" }
        },
        { 
          title: "Pasta", 
          b: "Wheat Bread, Peanut Butter", 
          l: "Whole Wheat Pasta, Tuna", 
          d: "Chicken Pesto Pasta",
          nutrition: { cal: "1140", protein: "87g", carbs: "136g", fat: "30g" }
        },
        { 
          title: "Tofu & Greens", 
          b: "Tofu Scramble, Spinach", 
          l: "Tofu Steak, Onions", 
          d: "Mapo Tofu (Mild)",
          nutrition: { cal: "1105", protein: "82g", carbs: "141g", fat: "27g" }
        },
        { 
          title: "Root Veg", 
          b: "Boiled Kamote, Egg", 
          l: "Chicken Stew, Sweet Potato", 
          d: "Picadillo (Lean Beef)",
          nutrition: { cal: "1130", protein: "89g", carbs: "137g", fat: "29g" }
        },
        { 
          title: "Grilled", 
          b: "Tuna Pandesal", 
          l: "Grilled Bangus, Salsa", 
          d: "Grilled Chicken, Balsamic",
          nutrition: { cal: "1115", protein: "85g", carbs: "139g", fat: "25g" }
        },
        { 
          title: "Spanish Style", 
          b: "Spanish Sardines, Brown Rice", 
          l: "Chickpea Stew", 
          d: "Fish Cardillo",
          nutrition: { cal: "1125", protein: "86g", carbs: "138g", fat: "28g" }
        },
        { 
          title: "Simple & Clean", 
          b: "Hard Boiled Eggs, Wheat Toast", 
          l: "Chicken Asado", 
          d: "Stir Fry Mixed Veg, Fish",
          nutrition: { cal: "1095", protein: "83g", carbs: "140g", fat: "26g" }
        }
      ]
    },
    "Balanced": {
        ...
        {menuData[activeCategory].items.map((item, index) => (
          <div key={index} className="menu-card">
            ...
            <div className="card-body">
              ...
              {/* 2. NUTRITION OVERLAY (Inside card-body to cover text only) */}
